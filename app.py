...
# Leer los datos
car_data = pd.read_csv = pd.read_csv(r"C:\Users\BETY_\Downloads\Analisis de datos\Sprint 6 Herramientas de desarrollo de software\Proyecto_final\analisis_exploratorio\vehicles_us.csv")
